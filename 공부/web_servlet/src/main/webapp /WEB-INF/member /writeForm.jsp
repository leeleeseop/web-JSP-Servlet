...
<div class="container">
	...
	<div class="form-group">
		...
		<input id="id" name="id" required autocomplete="off" class="form-control" maxlength="20" pattern="^[a-zA-Z][a-zA-Z0-9]{2,19}$"
			title="맨앞 글자는 영문자 뒤에는 영숫자 입력. 3~20 이내로 입력" placeholder="아이디 입력">
	</div>
	...
	<div class="form-group">
		...
		<input id="birth" name="birth" required autocomplete="off" class="form-control datepicker">
	</div>
	...
	<div class="form-group">
		...
		<input id="email" name="email" required class="form-control"  placeholder="id@도메인">
	</div>
