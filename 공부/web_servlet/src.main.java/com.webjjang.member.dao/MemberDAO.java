...
public class MemberDAO extends DAO{
	...
	// 2. 회원정보보기 처리
	// MemberController - (Execute) - MemberViewService - [MemberDAO.view()]
	...
	// 4-2. 회원 등급 수정 처리
	// MemberController - (Execute) - MemberChangeGrade - [MemberDAO.changeGrade()]
	...
	// 7. 최근 접속일 수정 처리
	// MemberController - (Execute) - MemberUpdateConDateService - [MemberDAO.updateConDate()]
	public int updateConDate(String id) throws Exception{
		...
		// 결과 데이터를 리턴해 준다.
		return result;
	} // end of updateConDate()
	

	// 8. 회원이 받는 새로운 메시지 개수 가져오기 처리
	// AjaxController - (Execute) - MembegetNewMsgCntService - [MemberDAO.getNewMsgCnt()]
